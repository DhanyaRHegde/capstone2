...
export default function Successful() {
  ...
  useEffect(() => {
    if (typeof window !== 'undefined') {
      const hasValidSession = sessionStorage.getItem('hasValidSession')
      if (!hasValidSession) {
        router.push('/')
      } else {
        // Remove the session flag to prevent direct access after successful order
        sessionStorage.removeItem('hasValidSession')
      }
    }
